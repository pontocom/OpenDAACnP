...
config.CSR_organizationUnitName = 'AssetDeliverySrv';

config.AuthSrv_IpAddress = '127.0.0.1';
config.AuthSrv_IpPort = 3000;


config.commonName = 'AssetDeliverySrv';
config.location = 'http://10.211.55.10:3000';
config.description = 'This is the asset delivery server, the service that is responsible for sending a protected asset to a client.';
